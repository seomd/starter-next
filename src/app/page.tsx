...
export default function Home() {
  ...
  const skillUrl =
    "Read https://seomd.dev/SKILL.md and follow the instructions.";
      ...
      <main className="relative z-10 w-full max-w-5xl">
        <div className="overflow-hidden rounded-[2.5rem] border border-white/70 bg-white/80 shadow-[0_40px_120px_-32px_rgba(15,23,42,0.18)] backdrop-blur-xl">
          <div className="grid grid-cols-1 lg:grid-cols-2">
            <div className="relative overflow-hidden border-b border-zinc-200/80 bg-[linear-gradient(135deg,_#fafafa_0%,_#f2f4f8_48%,_#fcfcff_100%)] px-8 py-8 lg:border-b-0 lg:border-r">
              ...
              <div className="relative h-full flex flex-col justify-center">
                ...
                <div className="mt-6 max-w-md space-y-3">
                  <p className="text-sm leading-7 text-zinc-600">
                    Paste this into your agent to set everything up
                    automatically:
                  </p>
                  <CopyableCode value={skillUrl} />
                  <ol className="space-y-2 mt-4 text-sm text-zinc-600">
                    <li>1. Send the URL to your agent</li>
                    <li>2. Agent reads &amp; sets everything up</li>
                    <li>3. Validate &amp; deploy</li>
                  </ol>
                </div>
              </div>
            </div>
